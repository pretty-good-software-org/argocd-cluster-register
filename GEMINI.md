...
**ArgoCD-Cluster-Register** is a Kubernetes operator (controller) built with Go and Kubebuilder. Its primary purpose is
to automate the registration of [Cluster-API (CAPI)](https://cluster-api.sigs.k8s.io/) clusters with
...
- **Language:** Go (v1.25+)
- **Framework:** [Kubebuilder](https://book.kubebuilder.io/) /
